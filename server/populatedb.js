...
// Use user argument for the URI, or default to local MongoDB URI
const mongoDB = userArgs[0] || 'mongodb://mongo:27017/local_library'; // Default to local if no argument is passed
...
// Create functions to populate data, like createGenres(), createAuthors(), etc.
